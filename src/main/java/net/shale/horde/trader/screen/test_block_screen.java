...
public class test_block_screen extends HandledScreen<test_block_screenhandler> {
    private static final Identifier TEXTURE =
            new Identifier(Main.ID, "textures/gui/orichalcum_blaster_gui.png");

    public test_block_screen(test_block_screenhandler handler, PlayerInventory inventory, Text title) {
