...
public class reg_screenhandler {
    ...
    public static ScreenHandlerType<combiner_screenhandler> COMBINER_SCREENHANDLER =
            ScreenHandlerRegistry.registerSimple(new Identifier(Main.ID, "combiner"),
                    combiner_screenhandler::new);
}
