...
public class combiner_screen extends HandledScreen<combiner_screenhandler> {
    private static final Identifier TEXTURE =
            new Identifier(Main.ID, "textures/gui/orichalcum_blaster_gui.png");

    public combiner_screen(combiner_screenhandler handler, PlayerInventory inventory, Text title) {
